...
class ExploreRated extends StatefulWidget {
  const ExploreRated({Key? key}) : super(key: key);

  @override
  _ExploreRatedState createState() => _ExploreRatedState();
}

class _ExploreRatedState extends State<ExploreRated> {
